...
Decay_t = Decay(name = 'Decay_t',
                ...
                partial_widths = {(P.W__plus__,P.b):'((MT**2 - MW**2)*((3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.Xc__tilde__,P.YF3Qu3):'((3*lamF3Q3x3**2*MT**2 - 3*lamF3Q3x3**2*MXc**2 + 3*lamF3Q3x3**2*MYF3Qu3**2)*cmath.sqrt(MT**4 - 2*MT**2*MXc**2 + MXc**4 - 2*MT**2*MYF3Qu3**2 - 2*MXc**2*MYF3Qu3**2 + MYF3Qu3**4))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.Xc__tilde__,P.YF3u3):'((3*lamF3u3x3**2*MT**2 - 3*lamF3u3x3**2*MXc**2 + 3*lamF3u3x3**2*MYF3u3**2)*cmath.sqrt(MT**4 - 2*MT**2*MXc**2 + MXc**4 - 2*MT**2*MYF3u3**2 - 2*MXc**2*MYF3u3**2 + MYF3u3**4))/(96.*cmath.pi*abs(MT)**3)',
                                  ...
                                  (P.Xw__tilde__,P.YF3Qu3):'((3*lamF3Q3x3**2*MT**2 + (3*lamF3Q3x3**2*MT**4)/MXw**2 - 6*lamF3Q3x3**2*MXw**2 + 3*lamF3Q3x3**2*MYF3Qu3**2 - (6*lamF3Q3x3**2*MT**2*MYF3Qu3**2)/MXw**2 + (3*lamF3Q3x3**2*MYF3Qu3**4)/MXw**2)*cmath.sqrt(MT**4 - 2*MT**2*MXw**2 + MXw**4 - 2*MT**2*MYF3Qu3**2 - 2*MXw**2*MYF3Qu3**2 + MYF3Qu3**4))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.Xw__tilde__,P.YF3u3):'((3*lamF3u3x3**2*MT**2 + (3*lamF3u3x3**2*MT**4)/MXw**2 - 6*lamF3u3x3**2*MXw**2 + 3*lamF3u3x3**2*MYF3u3**2 - (6*lamF3u3x3**2*MT**2*MYF3u3**2)/MXw**2 + (3*lamF3u3x3**2*MYF3u3**4)/MXw**2)*cmath.sqrt(MT**4 - 2*MT**2*MXw**2 + MXw**4 - 2*MT**2*MYF3u3**2 - 2*MXw**2*MYF3u3**2 + MYF3u3**4))/(96.*cmath.pi*abs(MT)**3)',
...
Decay_Xc = Decay(name = 'Decay_Xc',
                 particle = P.Xc,
                 partial_widths = {(P.YF3d1,P.d__tilde__):'((MXc**2 - MYF3d1**2)*(3*lamF3d1x1**2*MXc**2 - 3*lamF3d1x1**2*MYF3d1**2))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3d2,P.s__tilde__):'((MXc**2 - MYF3d2**2)*(3*lamF3d2x2**2*MXc**2 - 3*lamF3d2x2**2*MYF3d2**2))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3d3,P.b__tilde__):'((MXc**2 - MYF3d3**2)*(3*lamF3d3x3**2*MXc**2 - 3*lamF3d3x3**2*MYF3d3**2))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3Qd1,P.d__tilde__):'((MXc**2 - MYF3Qd1**2)*(3*lamF3Q1x1**2*MXc**2 - 3*lamF3Q1x1**2*MYF3Qd1**2))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3Qd2,P.s__tilde__):'((MXc**2 - MYF3Qd2**2)*(3*lamF3Q2x2**2*MXc**2 - 3*lamF3Q2x2**2*MYF3Qd2**2))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3Qd3,P.b__tilde__):'((MXc**2 - MYF3Qd3**2)*(3*lamF3Q3x3**2*MXc**2 - 3*lamF3Q3x3**2*MYF3Qd3**2))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3Qu1,P.u__tilde__):'((MXc**2 - MYF3Qu1**2)*(3*lamF3Q1x1**2*MXc**2 - 3*lamF3Q1x1**2*MYF3Qu1**2))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3Qu2,P.c__tilde__):'((MXc**2 - MYF3Qu2**2)*(3*lamF3Q2x2**2*MXc**2 - 3*lamF3Q2x2**2*MYF3Qu2**2))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3Qu3,P.t__tilde__):'((-3*lamF3Q3x3**2*MT**2 + 3*lamF3Q3x3**2*MXc**2 - 3*lamF3Q3x3**2*MYF3Qu3**2)*cmath.sqrt(MT**4 - 2*MT**2*MXc**2 + MXc**4 - 2*MT**2*MYF3Qu3**2 - 2*MXc**2*MYF3Qu3**2 + MYF3Qu3**4))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3u1,P.u__tilde__):'((MXc**2 - MYF3u1**2)*(3*lamF3u1x1**2*MXc**2 - 3*lamF3u1x1**2*MYF3u1**2))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3u2,P.c__tilde__):'((MXc**2 - MYF3u2**2)*(3*lamF3u2x2**2*MXc**2 - 3*lamF3u2x2**2*MYF3u2**2))/(16.*cmath.pi*abs(MXc)**3)',
                                   (P.YF3u3,P.t__tilde__):'((-3*lamF3u3x3**2*MT**2 + 3*lamF3u3x3**2*MXc**2 - 3*lamF3u3x3**2*MYF3u3**2)*cmath.sqrt(MT**4 - 2*MT**2*MXc**2 + MXc**4 - 2*MT**2*MYF3u3**2 - 2*MXc**2*MYF3u3**2 + MYF3u3**4))/(16.*cmath.pi*abs(MXc)**3)'})
...
Decay_Xw = Decay(name = 'Decay_Xw',
                 particle = P.Xw,
                 partial_widths = {(P.YF3d1,P.d__tilde__):'((MXw**2 - MYF3d1**2)*(6*lamF3d1x1**2*MXw**2 - 3*lamF3d1x1**2*MYF3d1**2 - (3*lamF3d1x1**2*MYF3d1**4)/MXw**2))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3d2,P.s__tilde__):'((MXw**2 - MYF3d2**2)*(6*lamF3d2x2**2*MXw**2 - 3*lamF3d2x2**2*MYF3d2**2 - (3*lamF3d2x2**2*MYF3d2**4)/MXw**2))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3d3,P.b__tilde__):'((MXw**2 - MYF3d3**2)*(6*lamF3d3x3**2*MXw**2 - 3*lamF3d3x3**2*MYF3d3**2 - (3*lamF3d3x3**2*MYF3d3**4)/MXw**2))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3Qd1,P.d__tilde__):'((MXw**2 - MYF3Qd1**2)*(6*lamF3Q1x1**2*MXw**2 - 3*lamF3Q1x1**2*MYF3Qd1**2 - (3*lamF3Q1x1**2*MYF3Qd1**4)/MXw**2))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3Qd2,P.s__tilde__):'((MXw**2 - MYF3Qd2**2)*(6*lamF3Q2x2**2*MXw**2 - 3*lamF3Q2x2**2*MYF3Qd2**2 - (3*lamF3Q2x2**2*MYF3Qd2**4)/MXw**2))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3Qd3,P.b__tilde__):'((MXw**2 - MYF3Qd3**2)*(6*lamF3Q3x3**2*MXw**2 - 3*lamF3Q3x3**2*MYF3Qd3**2 - (3*lamF3Q3x3**2*MYF3Qd3**4)/MXw**2))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3Qu1,P.u__tilde__):'((MXw**2 - MYF3Qu1**2)*(6*lamF3Q1x1**2*MXw**2 - 3*lamF3Q1x1**2*MYF3Qu1**2 - (3*lamF3Q1x1**2*MYF3Qu1**4)/MXw**2))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3Qu2,P.c__tilde__):'((MXw**2 - MYF3Qu2**2)*(6*lamF3Q2x2**2*MXw**2 - 3*lamF3Q2x2**2*MYF3Qu2**2 - (3*lamF3Q2x2**2*MYF3Qu2**4)/MXw**2))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3Qu3,P.t__tilde__):'((-3*lamF3Q3x3**2*MT**2 - (3*lamF3Q3x3**2*MT**4)/MXw**2 + 6*lamF3Q3x3**2*MXw**2 - 3*lamF3Q3x3**2*MYF3Qu3**2 + (6*lamF3Q3x3**2*MT**2*MYF3Qu3**2)/MXw**2 - (3*lamF3Q3x3**2*MYF3Qu3**4)/MXw**2)*cmath.sqrt(MT**4 - 2*MT**2*MXw**2 + MXw**4 - 2*MT**2*MYF3Qu3**2 - 2*MXw**2*MYF3Qu3**2 + MYF3Qu3**4))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3u1,P.u__tilde__):'((MXw**2 - MYF3u1**2)*(6*lamF3u1x1**2*MXw**2 - 3*lamF3u1x1**2*MYF3u1**2 - (3*lamF3u1x1**2*MYF3u1**4)/MXw**2))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3u2,P.c__tilde__):'((MXw**2 - MYF3u2**2)*(6*lamF3u2x2**2*MXw**2 - 3*lamF3u2x2**2*MYF3u2**2 - (3*lamF3u2x2**2*MYF3u2**4)/MXw**2))/(48.*cmath.pi*abs(MXw)**3)',
                                   (P.YF3u3,P.t__tilde__):'((-3*lamF3u3x3**2*MT**2 - (3*lamF3u3x3**2*MT**4)/MXw**2 + 6*lamF3u3x3**2*MXw**2 - 3*lamF3u3x3**2*MYF3u3**2 + (6*lamF3u3x3**2*MT**2*MYF3u3**2)/MXw**2 - (3*lamF3u3x3**2*MYF3u3**4)/MXw**2)*cmath.sqrt(MT**4 - 2*MT**2*MXw**2 + MXw**4 - 2*MT**2*MYF3u3**2 - 2*MXw**2*MYF3u3**2 + MYF3u3**4))/(48.*cmath.pi*abs(MXw)**3)'})

Decay_YF3d1 = Decay(name = 'Decay_YF3d1',
                    particle = P.YF3d1,
                    partial_widths = {(P.Xc,P.d):'((-MXc**2 + MYF3d1**2)*(-3*lamF3d1x1**2*MXc**2 + 3*lamF3d1x1**2*MYF3d1**2))/(96.*cmath.pi*abs(MYF3d1)**3)',
                                      (P.Xs,P.d):'((-MXs**2 + MYF3d1**2)*(-3*lamF3d1x1**2*MXs**2 + 3*lamF3d1x1**2*MYF3d1**2))/(96.*cmath.pi*abs(MYF3d1)**3)',
                                      (P.Xv,P.d):'((-MXv**2 + MYF3d1**2)*(-6*lamF3d1x1**2*MXv**2 + 3*lamF3d1x1**2*MYF3d1**2 + (3*lamF3d1x1**2*MYF3d1**4)/MXv**2))/(96.*cmath.pi*abs(MYF3d1)**3)',
                                      (P.Xw,P.d):'((-MXw**2 + MYF3d1**2)*(-6*lamF3d1x1**2*MXw**2 + 3*lamF3d1x1**2*MYF3d1**2 + (3*lamF3d1x1**2*MYF3d1**4)/MXw**2))/(96.*cmath.pi*abs(MYF3d1)**3)'})

Decay_YF3d2 = Decay(name = 'Decay_YF3d2',
                    particle = P.YF3d2,
                    partial_widths = {(P.Xc,P.s):'((-MXc**2 + MYF3d2**2)*(-3*lamF3d2x2**2*MXc**2 + 3*lamF3d2x2**2*MYF3d2**2))/(96.*cmath.pi*abs(MYF3d2)**3)',
                                      (P.Xs,P.s):'((-MXs**2 + MYF3d2**2)*(-3*lamF3d2x2**2*MXs**2 + 3*lamF3d2x2**2*MYF3d2**2))/(96.*cmath.pi*abs(MYF3d2)**3)',
                                      (P.Xv,P.s):'((-MXv**2 + MYF3d2**2)*(-6*lamF3d2x2**2*MXv**2 + 3*lamF3d2x2**2*MYF3d2**2 + (3*lamF3d2x2**2*MYF3d2**4)/MXv**2))/(96.*cmath.pi*abs(MYF3d2)**3)',
                                      (P.Xw,P.s):'((-MXw**2 + MYF3d2**2)*(-6*lamF3d2x2**2*MXw**2 + 3*lamF3d2x2**2*MYF3d2**2 + (3*lamF3d2x2**2*MYF3d2**4)/MXw**2))/(96.*cmath.pi*abs(MYF3d2)**3)'})

Decay_YF3d3 = Decay(name = 'Decay_YF3d3',
                    particle = P.YF3d3,
                    partial_widths = {(P.Xc,P.b):'((-MXc**2 + MYF3d3**2)*(-3*lamF3d3x3**2*MXc**2 + 3*lamF3d3x3**2*MYF3d3**2))/(96.*cmath.pi*abs(MYF3d3)**3)',
                                      (P.Xs,P.b):'((-MXs**2 + MYF3d3**2)*(-3*lamF3d3x3**2*MXs**2 + 3*lamF3d3x3**2*MYF3d3**2))/(96.*cmath.pi*abs(MYF3d3)**3)',
                                      (P.Xv,P.b):'((-MXv**2 + MYF3d3**2)*(-6*lamF3d3x3**2*MXv**2 + 3*lamF3d3x3**2*MYF3d3**2 + (3*lamF3d3x3**2*MYF3d3**4)/MXv**2))/(96.*cmath.pi*abs(MYF3d3)**3)',
                                      (P.Xw,P.b):'((-MXw**2 + MYF3d3**2)*(-6*lamF3d3x3**2*MXw**2 + 3*lamF3d3x3**2*MYF3d3**2 + (3*lamF3d3x3**2*MYF3d3**4)/MXw**2))/(96.*cmath.pi*abs(MYF3d3)**3)'})
...
Decay_YF3Qd1 = Decay(name = 'Decay_YF3Qd1',
                     ...
                     partial_widths = {(P.W__minus__,P.YF3Qu1):'(((-6*ee**2*MW**2)/sw**2 + (3*ee**2*MYF3Qd1**2)/sw**2 + (3*ee**2*MYF3Qd1**4)/(MW**2*sw**2) - (18*ee**2*MYF3Qd1*MYF3Qu1)/sw**2 + (3*ee**2*MYF3Qu1**2)/sw**2 - (6*ee**2*MYF3Qd1**2*MYF3Qu1**2)/(MW**2*sw**2) + (3*ee**2*MYF3Qu1**4)/(MW**2*sw**2))*cmath.sqrt(MW**4 - 2*MW**2*MYF3Qd1**2 + MYF3Qd1**4 - 2*MW**2*MYF3Qu1**2 - 2*MYF3Qd1**2*MYF3Qu1**2 + MYF3Qu1**4))/(96.*cmath.pi*abs(MYF3Qd1)**3)',
                                       (P.Xc,P.d):'((-MXc**2 + MYF3Qd1**2)*(-3*lamF3Q1x1**2*MXc**2 + 3*lamF3Q1x1**2*MYF3Qd1**2))/(96.*cmath.pi*abs(MYF3Qd1)**3)',
                                       ...
                                       (P.Xw,P.d):'((-MXw**2 + MYF3Qd1**2)*(-6*lamF3Q1x1**2*MXw**2 + 3*lamF3Q1x1**2*MYF3Qd1**2 + (3*lamF3Q1x1**2*MYF3Qd1**4)/MXw**2))/(96.*cmath.pi*abs(MYF3Qd1)**3)'})
...
Decay_YF3Qd2 = Decay(name = 'Decay_YF3Qd2',
                     ...
                     partial_widths = {(P.W__minus__,P.YF3Qu2):'(((-6*ee**2*MW**2)/sw**2 + (3*ee**2*MYF3Qd2**2)/sw**2 + (3*ee**2*MYF3Qd2**4)/(MW**2*sw**2) - (18*ee**2*MYF3Qd2*MYF3Qu2)/sw**2 + (3*ee**2*MYF3Qu2**2)/sw**2 - (6*ee**2*MYF3Qd2**2*MYF3Qu2**2)/(MW**2*sw**2) + (3*ee**2*MYF3Qu2**4)/(MW**2*sw**2))*cmath.sqrt(MW**4 - 2*MW**2*MYF3Qd2**2 + MYF3Qd2**4 - 2*MW**2*MYF3Qu2**2 - 2*MYF3Qd2**2*MYF3Qu2**2 + MYF3Qu2**4))/(96.*cmath.pi*abs(MYF3Qd2)**3)',
                                       (P.Xc,P.s):'((-MXc**2 + MYF3Qd2**2)*(-3*lamF3Q2x2**2*MXc**2 + 3*lamF3Q2x2**2*MYF3Qd2**2))/(96.*cmath.pi*abs(MYF3Qd2)**3)',
                                       ...
                                       (P.Xw,P.s):'((-MXw**2 + MYF3Qd2**2)*(-6*lamF3Q2x2**2*MXw**2 + 3*lamF3Q2x2**2*MYF3Qd2**2 + (3*lamF3Q2x2**2*MYF3Qd2**4)/MXw**2))/(96.*cmath.pi*abs(MYF3Qd2)**3)'})
...
Decay_YF3Qd3 = Decay(name = 'Decay_YF3Qd3',
                     ...
                     partial_widths = {(P.W__minus__,P.YF3Qu3):'(((-6*ee**2*MW**2)/sw**2 + (3*ee**2*MYF3Qd3**2)/sw**2 + (3*ee**2*MYF3Qd3**4)/(MW**2*sw**2) - (18*ee**2*MYF3Qd3*MYF3Qu3)/sw**2 + (3*ee**2*MYF3Qu3**2)/sw**2 - (6*ee**2*MYF3Qd3**2*MYF3Qu3**2)/(MW**2*sw**2) + (3*ee**2*MYF3Qu3**4)/(MW**2*sw**2))*cmath.sqrt(MW**4 - 2*MW**2*MYF3Qd3**2 + MYF3Qd3**4 - 2*MW**2*MYF3Qu3**2 - 2*MYF3Qd3**2*MYF3Qu3**2 + MYF3Qu3**4))/(96.*cmath.pi*abs(MYF3Qd3)**3)',
                                       (P.Xc,P.b):'((-MXc**2 + MYF3Qd3**2)*(-3*lamF3Q3x3**2*MXc**2 + 3*lamF3Q3x3**2*MYF3Qd3**2))/(96.*cmath.pi*abs(MYF3Qd3)**3)',
                                       ...
                                       (P.Xw,P.b):'((-MXw**2 + MYF3Qd3**2)*(-6*lamF3Q3x3**2*MXw**2 + 3*lamF3Q3x3**2*MYF3Qd3**2 + (3*lamF3Q3x3**2*MYF3Qd3**4)/MXw**2))/(96.*cmath.pi*abs(MYF3Qd3)**3)'})
...
Decay_YF3Qu1 = Decay(name = 'Decay_YF3Qu1',
                     ...
                     partial_widths = {(P.W__plus__,P.YF3Qd1):'(((-6*ee**2*MW**2)/sw**2 + (3*ee**2*MYF3Qd1**2)/sw**2 + (3*ee**2*MYF3Qd1**4)/(MW**2*sw**2) - (18*ee**2*MYF3Qd1*MYF3Qu1)/sw**2 + (3*ee**2*MYF3Qu1**2)/sw**2 - (6*ee**2*MYF3Qd1**2*MYF3Qu1**2)/(MW**2*sw**2) + (3*ee**2*MYF3Qu1**4)/(MW**2*sw**2))*cmath.sqrt(MW**4 - 2*MW**2*MYF3Qd1**2 + MYF3Qd1**4 - 2*MW**2*MYF3Qu1**2 - 2*MYF3Qd1**2*MYF3Qu1**2 + MYF3Qu1**4))/(96.*cmath.pi*abs(MYF3Qu1)**3)',
                                       (P.Xc,P.u):'((-MXc**2 + MYF3Qu1**2)*(-3*lamF3Q1x1**2*MXc**2 + 3*lamF3Q1x1**2*MYF3Qu1**2))/(96.*cmath.pi*abs(MYF3Qu1)**3)',
                                       ...
                                       (P.Xw,P.u):'((-MXw**2 + MYF3Qu1**2)*(-6*lamF3Q1x1**2*MXw**2 + 3*lamF3Q1x1**2*MYF3Qu1**2 + (3*lamF3Q1x1**2*MYF3Qu1**4)/MXw**2))/(96.*cmath.pi*abs(MYF3Qu1)**3)'})
...
Decay_YF3Qu2 = Decay(name = 'Decay_YF3Qu2',
                     ...
                     partial_widths = {(P.W__plus__,P.YF3Qd2):'(((-6*ee**2*MW**2)/sw**2 + (3*ee**2*MYF3Qd2**2)/sw**2 + (3*ee**2*MYF3Qd2**4)/(MW**2*sw**2) - (18*ee**2*MYF3Qd2*MYF3Qu2)/sw**2 + (3*ee**2*MYF3Qu2**2)/sw**2 - (6*ee**2*MYF3Qd2**2*MYF3Qu2**2)/(MW**2*sw**2) + (3*ee**2*MYF3Qu2**4)/(MW**2*sw**2))*cmath.sqrt(MW**4 - 2*MW**2*MYF3Qd2**2 + MYF3Qd2**4 - 2*MW**2*MYF3Qu2**2 - 2*MYF3Qd2**2*MYF3Qu2**2 + MYF3Qu2**4))/(96.*cmath.pi*abs(MYF3Qu2)**3)',
                                       (P.Xc,P.c):'((-MXc**2 + MYF3Qu2**2)*(-3*lamF3Q2x2**2*MXc**2 + 3*lamF3Q2x2**2*MYF3Qu2**2))/(96.*cmath.pi*abs(MYF3Qu2)**3)',
                                       ...
                                       (P.Xw,P.c):'((-MXw**2 + MYF3Qu2**2)*(-6*lamF3Q2x2**2*MXw**2 + 3*lamF3Q2x2**2*MYF3Qu2**2 + (3*lamF3Q2x2**2*MYF3Qu2**4)/MXw**2))/(96.*cmath.pi*abs(MYF3Qu2)**3)'})
...
Decay_YF3Qu3 = Decay(name = 'Decay_YF3Qu3',
                     ...
                     partial_widths = {(P.W__plus__,P.YF3Qd3):'(((-6*ee**2*MW**2)/sw**2 + (3*ee**2*MYF3Qd3**2)/sw**2 + (3*ee**2*MYF3Qd3**4)/(MW**2*sw**2) - (18*ee**2*MYF3Qd3*MYF3Qu3)/sw**2 + (3*ee**2*MYF3Qu3**2)/sw**2 - (6*ee**2*MYF3Qd3**2*MYF3Qu3**2)/(MW**2*sw**2) + (3*ee**2*MYF3Qu3**4)/(MW**2*sw**2))*cmath.sqrt(MW**4 - 2*MW**2*MYF3Qd3**2 + MYF3Qd3**4 - 2*MW**2*MYF3Qu3**2 - 2*MYF3Qd3**2*MYF3Qu3**2 + MYF3Qu3**4))/(96.*cmath.pi*abs(MYF3Qu3)**3)',
                                       (P.Xc,P.t):'((3*lamF3Q3x3**2*MT**2 - 3*lamF3Q3x3**2*MXc**2 + 3*lamF3Q3x3**2*MYF3Qu3**2)*cmath.sqrt(MT**4 - 2*MT**2*MXc**2 + MXc**4 - 2*MT**2*MYF3Qu3**2 - 2*MXc**2*MYF3Qu3**2 + MYF3Qu3**4))/(96.*cmath.pi*abs(MYF3Qu3)**3)',
                                       ...
                                       (P.Xw,P.t):'((3*lamF3Q3x3**2*MT**2 + (3*lamF3Q3x3**2*MT**4)/MXw**2 - 6*lamF3Q3x3**2*MXw**2 + 3*lamF3Q3x3**2*MYF3Qu3**2 - (6*lamF3Q3x3**2*MT**2*MYF3Qu3**2)/MXw**2 + (3*lamF3Q3x3**2*MYF3Qu3**4)/MXw**2)*cmath.sqrt(MT**4 - 2*MT**2*MXw**2 + MXw**4 - 2*MT**2*MYF3Qu3**2 - 2*MXw**2*MYF3Qu3**2 + MYF3Qu3**4))/(96.*cmath.pi*abs(MYF3Qu3)**3)'})

Decay_YF3u1 = Decay(name = 'Decay_YF3u1',
                    particle = P.YF3u1,
                    partial_widths = {(P.Xc,P.u):'((-MXc**2 + MYF3u1**2)*(-3*lamF3u1x1**2*MXc**2 + 3*lamF3u1x1**2*MYF3u1**2))/(96.*cmath.pi*abs(MYF3u1)**3)',
                                      (P.Xs,P.u):'((-MXs**2 + MYF3u1**2)*(-3*lamF3u1x1**2*MXs**2 + 3*lamF3u1x1**2*MYF3u1**2))/(96.*cmath.pi*abs(MYF3u1)**3)',
                                      (P.Xv,P.u):'((-MXv**2 + MYF3u1**2)*(-6*lamF3u1x1**2*MXv**2 + 3*lamF3u1x1**2*MYF3u1**2 + (3*lamF3u1x1**2*MYF3u1**4)/MXv**2))/(96.*cmath.pi*abs(MYF3u1)**3)',
                                      (P.Xw,P.u):'((-MXw**2 + MYF3u1**2)*(-6*lamF3u1x1**2*MXw**2 + 3*lamF3u1x1**2*MYF3u1**2 + (3*lamF3u1x1**2*MYF3u1**4)/MXw**2))/(96.*cmath.pi*abs(MYF3u1)**3)'})

Decay_YF3u2 = Decay(name = 'Decay_YF3u2',
                    particle = P.YF3u2,
                    partial_widths = {(P.Xc,P.c):'((-MXc**2 + MYF3u2**2)*(-3*lamF3u2x2**2*MXc**2 + 3*lamF3u2x2**2*MYF3u2**2))/(96.*cmath.pi*abs(MYF3u2)**3)',
                                      (P.Xs,P.c):'((-MXs**2 + MYF3u2**2)*(-3*lamF3u2x2**2*MXs**2 + 3*lamF3u2x2**2*MYF3u2**2))/(96.*cmath.pi*abs(MYF3u2)**3)',
                                      (P.Xv,P.c):'((-MXv**2 + MYF3u2**2)*(-6*lamF3u2x2**2*MXv**2 + 3*lamF3u2x2**2*MYF3u2**2 + (3*lamF3u2x2**2*MYF3u2**4)/MXv**2))/(96.*cmath.pi*abs(MYF3u2)**3)',
                                      (P.Xw,P.c):'((-MXw**2 + MYF3u2**2)*(-6*lamF3u2x2**2*MXw**2 + 3*lamF3u2x2**2*MYF3u2**2 + (3*lamF3u2x2**2*MYF3u2**4)/MXw**2))/(96.*cmath.pi*abs(MYF3u2)**3)'})

Decay_YF3u3 = Decay(name = 'Decay_YF3u3',
                    particle = P.YF3u3,
                    partial_widths = {(P.Xc,P.t):'((3*lamF3u3x3**2*MT**2 - 3*lamF3u3x3**2*MXc**2 + 3*lamF3u3x3**2*MYF3u3**2)*cmath.sqrt(MT**4 - 2*MT**2*MXc**2 + MXc**4 - 2*MT**2*MYF3u3**2 - 2*MXc**2*MYF3u3**2 + MYF3u3**4))/(96.*cmath.pi*abs(MYF3u3)**3)',
                                      (P.Xs,P.t):'((3*lamF3u3x3**2*MT**2 - 3*lamF3u3x3**2*MXs**2 + 3*lamF3u3x3**2*MYF3u3**2)*cmath.sqrt(MT**4 - 2*MT**2*MXs**2 + MXs**4 - 2*MT**2*MYF3u3**2 - 2*MXs**2*MYF3u3**2 + MYF3u3**4))/(96.*cmath.pi*abs(MYF3u3)**3)',
                                      ...
                                      (P.Xw,P.t):'((3*lamF3u3x3**2*MT**2 + (3*lamF3u3x3**2*MT**4)/MXw**2 - 6*lamF3u3x3**2*MXw**2 + 3*lamF3u3x3**2*MYF3u3**2 - (6*lamF3u3x3**2*MT**2*MYF3u3**2)/MXw**2 + (3*lamF3u3x3**2*MYF3u3**4)/MXw**2)*cmath.sqrt(MT**4 - 2*MT**2*MXw**2 + MXw**4 - 2*MT**2*MYF3u3**2 - 2*MXw**2*MYF3u3**2 + MYF3u3**4))/(96.*cmath.pi*abs(MYF3u3)**3)'})
